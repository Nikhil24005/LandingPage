...
export default function MentorMenteeProgram() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 relative flex flex-col items-center">
      {/* Hero Image Section */}
      ...
      {/* About Section */}
      <div className="w-full bg-red-200 hover:bg-red-800 hover:text-white transition-colors duration-300 rounded-lg p-6 shadow-lg mt-6">
        <h2 className="text-xl font-bold mb-4">About Mentor-Mentee Program</h2>
        <p className="mb-4">
      ...
      <div className="flex flex-col md:flex-row gap-6 mt-6 w-full">
        {/* Mentee Section */}
        <div className="w-full md:w-1/2 bg-red-200 hover:bg-red-800 hover:text-white transition-colors duration-300 rounded-lg p-6 shadow-lg">
          <h2 className="text-xl font-bold mb-4 text-center">Mentee</h2>
        ...
        {/* Mentor Section */}
        <div className="w-full md:w-1/2 bg-red-200 hover:bg-red-800 hover:text-white transition-colors duration-300 rounded-lg p-6 shadow-lg">
          <h2 className="text-xl font-bold mb-4 text-center">Mentor</h2>
          <p className="text-left">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center w-full mt-12 pt-6">
        ...
        <div className="w-1/2 text-center p-4">
          <h2 className="text-3xl font-bold">{menteeCount.toLocaleString()}+</h2>
          <p className="text-lg">Mentee</p>
        </div>

        {/* Vertical Line */}
        <div className="hidden md:block w-px bg-gray-700 h-20"></div>

        {/* Mentor Count */}
        <div className="w-1/2 text-center p-4">
          <h2 className="text-3xl font-bold">{mentorCount.toLocaleString()}+</h2>
